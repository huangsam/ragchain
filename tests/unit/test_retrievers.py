...
def test_ensemble_retriever_get_relevant_documents():
    ...
    with patch("ragchain.retrieval.retrievers.log_with_prefix"), patch("ragchain.retrieval.retrievers.log_timing"), patch("ragchain.retrieval.retrievers.time") as MockTime:
